...
# react-webpack-6-bootstrap-5

React 17 Boilerplate with React 17, Webpack 6, Bootstrap 5, HMR, using babel, Jest unit testing, sass, with a hot dev server and an optimized production build
